...
void RayTracer::Utils::Config::ConfigManager::_getSphere(
...
void RayTracer::Utils::Config::ConfigManager::_getPlane(
        const libconfig::Setting &primitive) {
    try {
        const libconfig::Setting& color = primitive["color"];
...
void RayTracer::Utils::Config::ConfigManager::_getPrimitives(
        const libconfig::Setting &root) {
    try {
